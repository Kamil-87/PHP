...
<div class="product">
    ...
    <img src="images/max/{$row['name_image']}" alt="Canon" class="product__image">
    ...
    <a href="?p=basket&a=add&id=$id" class="btn">Добавить в корзину</a><br><br>
    ...
    <div class="card">
        <div class="card__header">
            <a href="?p=catalog&a=one&id={$row['id']}">
                <div class="img_wrap">
                    <img src="images/{$row['name_image']}" alt="Canon">
                </div>
            </a>
        </div>
